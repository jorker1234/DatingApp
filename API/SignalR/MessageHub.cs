...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            var receipent = await _unitOfWork.UserRepository.GetUserByUsernameAsync(createMessageDto.RecipientUsername);
            ...
            {
                var connections = await _tracker.GetConnectionsForUser(receipent.UserName);
                if (connections != null)
                {
